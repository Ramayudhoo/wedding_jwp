                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      ...
                      <textarea class="form-control" id="exampleAdress1" name="adress" rows="4"><?= $settings->address; ?></textarea>
                    </div>
                     <div class="form-group">
                      <label for="exampleMaps1">Maps</label>
                      <textarea class="form-control" id="exampleMaps" name="maps" rows="4"><?= $settings->maps; ?></textarea>
                    </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                      <label for="exampleHeaderBusinessHout1">Header Business Hour</label>
                      <textarea class="form-control" id="exampleAdress1" name="header_business_hour" rows="4"><?= $settings->header_business_hour; ?></textarea>
                    </div>
                     <div class="form-group">
                      <label for="exampleTimeBusinessHour1">Time Business Hour</label>
                      <textarea class="form-control" id="exampleMaps" name="time_business_hour" rows="4"><?= $settings->time_business_hour; ?></textarea>
                    </div>
                    </div>
