                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    <div class="editor-container">
                                        ...
                                        <textarea name="description" id="editor" class="form-control" rows="4"><?= $katalog->description; ?>
                                        </textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="price" id="exampleInputName1" class="form-control" placeholder="Harga" value="<?= $katalog->price; ?>" required>
                                </div>
                                <div class="form-group">
