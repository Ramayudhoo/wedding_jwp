...
class Katalog extends CI_Controller {
        ...
        if ($this->input->post()) {
            ...
            if ($insert) {
                ...
                redirect('admin/Katalog');
                 ...
                 $this->session->set_flashdata('message', '<div class="alert alert-danger alert-dismissible fade show" role="alert"><strong>Upss </strong>Data Gagal Disimpan! <i class="remove ti-close" data-dismiss="alert"></i></div>');
                redirect('admin/Katalog');
            }
        } else {
            redirect('admin/Katalog');
    ...
    public function updateData() {
        if ($this->input->post()) {
            ...
            if ($cek_data > 0) {
                ...
                if ($update) {
                    $this->session->set_flashdata('message', '<div class="alert alert-success   alert-dismissible fade show" role="alert"><strong>Success </strong>Data Berhasil  Diubah! <i class="remove ti-close" data-dismiss="alert"></i></div>');
                    redirect('admin/Katalog');
                } else {
                    $this->session->set_flashdata('message', '<div class="alert alert-danger    alert-dismissible fade show" role="alert"><strong>Upss </strong>Data Gagal Diubah! <i  class="remove ti-close" data-dismiss="alert"></i></div>');
                    redirect('admin/Katalog');
                }
            }
        } else {
    ...
    public function delete() {
        if (!empty($this->input->get('id', true))) {
            ...
            if ($delete) {
                $this->session->set_flashdata('message', '<div class="alert-success alert-dismissible fade show" role="alert"><strong>Success </strong>Data Berhasil Dihapus! 
                <i class="remove ti-close" data-dismiss="alert"></i></div>');
                redirect('admin/Katalog');
            } else {
                $this->session->set_flashdata('message', '<div class="alert-danger alert-dismissible fade show" role="alert"><strong>Upss </strong>Data Gagal Dihapus! <i class="remove ti-close" data-dismiss="alert"></i></div>');
                redirect('admin/Katalog');
            }
        } else {
            redirect('admin/Katalog');
